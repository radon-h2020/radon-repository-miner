...
class AnsibleFixingCommitClassifierTestSuite(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.commit_obj = list(Repository(path_to_repo='https://github.com/stefanodallapalma/test-github-apis',
                                         only_commits=[
                                            'c9ada15de53d048f4d8e74d12bea62174bc0f957']).traverse_commits())[0]

    @staticmethod
    def test_comment_changed_true():
        commit = list(Repository(path_to_repo=os.path.join(os.getcwd(), 'test_data', 'repositories', 'COLARepo'),
    ...
    def test_service_changed():
        for commit in Repository(path_to_repo='https://github.com/usableprivacy/upribox/',
    ...
    def test_include_changed():
        for commit in Repository(path_to_repo='https://github.com/iiab/iiab/',
